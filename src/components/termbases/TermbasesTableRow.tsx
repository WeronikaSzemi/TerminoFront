...
import {DeleteTermbaseConfirm} from './DeleteTermbaseConfirm';
...
export const TermbasesTableRow = (props: Props) => {
    ...
    const {termbaseName, setTermbaseName} = useContext(TermbaseContext);
    ...
    return <tr>
        ...
        <td>
            <Link to={`/user/${userName}/termbases/${props.termbase.termbaseName}`}
                  className="btn btn-sm theme-btn-mainbrand mx-1 my-1 my-md-0"
                  onClick={handleTermbaseView}
            >
            ...
            <Link to={`/user/:userName/termbases/${props.termbase.termbaseName}/edit`}
